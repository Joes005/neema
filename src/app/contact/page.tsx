    ...
    <div className="relative z-0 bg-[#1C1B18]">
      ...
      <section className="pt-36 pb-20 px-6 lg:px-10 max-w-7xl mx-auto">
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
          {/* Direct Contact Info */}
          <div className="lg:col-span-5 space-y-8 bg-white p-8 lg:p-10 rounded-2xl border border-[#1C1B18]/10">
            <div>
          ...
          <div className="lg:col-span-7 bg-white p-8 lg:p-10 rounded-2xl border border-[#1C1B18]/10">
