        ...
        <main className="flex-1">
          ...
          <section className="pt-28 sm:pt-36 pb-16 lg:pb-20 px-4 sm:px-6 lg:px-10 max-w-7xl mx-auto">
            <RevealOnScroll direction="up">
              <p className="eyebrow text-[#71552F]">DESIGN & EXECUTION SEQUENCE</p>
                ...
                <RevealOnScroll key={phase.step} delay={idx * 0.1} direction="up">
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-8 items-start p-5 sm:p-8 rounded-2xl bg-white border border-[#1C1B18]/10 hover:border-[#C5A880] transition-colors shadow-sm">
                    <div className="md:col-span-3 flex flex-col justify-between">
                      <span className="font-sans text-2xl font-bold tracking-[0.2em] text-[#71552F]">
                        {phase.step}
                      </span>
                      <span className="text-xs uppercase tracking-[0.18em] text-[#1C1B18]/75 mt-2 font-medium">
                        {phase.duration}
                      </span>
                    </div>
                    ...
                    <div className="md:col-span-9">
                      ...
                      <p className="text-sm font-normal leading-relaxed text-[#1C1B18]/80 mt-3">
                        {phase.description}
                      </p>
                    </div>
                  </div>
