        ...
        {selectedProject && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-5xl bg-[#1C1B18] text-[#F9F8F3] rounded-2xl overflow-hidden shadow-2xl border border-white/10 grid grid-cols-1 lg:grid-cols-12"
            >
              {/* Close Button */}
              <button
                onClick={() => setSelectedProject(null)}
